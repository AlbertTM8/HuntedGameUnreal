...
UCLASS()
class MULTIPLAYERCOURSE_API AMazeGenerator : public AActor
{
	GENERATED_BODY()
public:	
...
protected:
    ...
    class MazeData {
    public:
        MazeData(AMazeGenerator& MazeGenerator) : MazeGen{MazeGenerator} {}
...
public:
    ...
    UPROPERTY(EditAnywhere)
		TArray<int8> RoomSizes;
    
    UPROPERTY(EditAnywhere)
		TArray<int32> RoomStartPositions;
